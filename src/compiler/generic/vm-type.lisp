;;; Implementation-dependent parts of the type support code.  This is stuff
;;; which deals with the mapping from types defined in Lisp to types
;;; actually supported by an implementation.
...
;;; Short-Float.  This is be expanded before the translator gets a chance,
...
;;; The kinds of specialised array that actually exist in this
;;; implementation.
;;;
...
;;; array will actually be implemented.  We set the
;;; Specialized-Element-Type to correspond to the actual specialization
...
;;; primitive-type, then return the template's name.  Otherwise, return
;;; NIL.
;;;
