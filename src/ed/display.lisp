...
;;;
;;; Then we check for the after-redisplay method.  Routines such as
;;; REDISPLAY and REDISPLAY-ALL want to invoke the after method to make
...
;;; call the device after-redisplay method since stream output may occur
;;; without ever returning to the editor input/event-handling loop.
;;;
