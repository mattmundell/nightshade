...
(if (find-package "CD")
    (rename-package "CD" "CD" ())
    (make-package "CD" :nicknames () :use ()))
(if (find-package "CSS")
    (rename-package "CSS" "CSS" ())
    (make-package "CSS" :nicknames () :use ()))
...
(use-package '("LISP" "EXTENSIONS" "ALIEN" "C-CALL") "CD")
(use-package '("LISP" "EXTENSIONS") "CSS")
...
(defpackage "INSPECT"
  (:export "*INTERFACE-STYLE*" "DESCRIBE-PARTS" "REMOVE-ALL-DISPLAYS"
...
(defpackage "UNIX"
  (:export "CADDR-T" "D-INO" "D-NAME" "D-NAMLEN" "D-OFF" "D-RECLEN"
	   ...
	   "ENOBUFS" "EPROCLIM" "EROFS" "ETOOMANYREFS"
	   "UNIX-FILE-KIND" "UNIX-FILE-KIND-FROM-MODE"
...
(defpackage "LISP"
  ...
  (:export "&ALLOW-OTHER-KEYS" "&AUX" "&BODY" "&ENVIRONMENT" "&KEY"
	   ...
	   "PRINT-UNREADABLE-OBJECT" "PROBE-FILE" "PROBE-LOCAL-FILE"
	   "PROCLAIM" "PROG" "PROG*"
...
(defpackage "EXTENSIONS"
  ...
  (:export
   ...
   "DELETEF" "DELETE-STRING" "DELQ"
   "DIR=" "DISABLE-CLX-EVENT-HANDLING"
   ...
   "FILE=" "FILE-COMMENT" "FILE-READABLE" "FILE-WRITABLE"
   ...
   "HEBREW-FROM-ABSOLUTE"
   "ISLAMIC-FROM-ABSOLUTE"
   "ISO-FROM-ABSOLUTE"
   "JULIAN-FROM-ABSOLUTE"
   "LAST-DAY-OF-FRENCH-MONTH"
   "LAST-DAY-OF-GREGORIAN-MONTH"
   "LAST-DAY-OF-HEBREW-MONTH"
   "LAST-DAY-OF-ISLAMIC-MONTH"
   "LAST-DAY-OF-JULIAN-MONTH"
   "MONTH-NAME"
   "MONTH-NUMBER"
   "PARSE-ISO8601-TIME"
   "SHORT-MONTH-NAME"
...
(defpackage "KERNEL"
  ...
  (:export "%ACOS" "%ACOSH" "%ARRAY-AVAILABLE-ELEMENTS"
	   ...
	   "ALIEN-TYPE-TYPE-ALIEN-TYPE" "ALIEN-TYPE-TYPE-P" "VVV" "ALLOCATE-VECTOR"
...
(defpackage "XLIB"
  (:export "BELL"
	   ...
	   "X-BOOLE-1"
	   "X-BOOLE-AND"
	   "X-BOOLE-AND-REVERSED"
	   "X-BOOLE-COPY"
	   "X-BOOLE-AND-INVERTED"
	   "X-BOOLE-NOOP"
	   "X-BOOLE-XOR"
	   "X-BOOLE-OR"
	   "X-BOOLE-NOR"
...
(defpackage "PARSE"
  (:export "*MARK*" "*MARKS*" "*STREAM*" "*STREAMS*"
	   "CH"
	   "CHAR-NODE" "CHAR-NODE-CONTENT" "CHAR-NODE-NEXT"
	   "CHAR-NODE-PARENT" "CHAR-NODE-PREVIOUS"
	   "COPY-STREAMS"
	   "DEFPARSER"
	   "DEFINE-PARSER"
...
(defpackage "SHELL"
  (:use "LISP" "EXT")
  (:export "~" "&&" "||" "]" "]]" ">>" "["
	   "CD" "CAT" #| "DIR" |# "ECH" "LS" "MV" "PWD" "RM" "SHE" "TOUCH")
  (:documentation "Unix shell-style functions for the REPL."))

(defpackage "CD"
  (:use "LISP" "EXT" "ALIEN" "C-CALL")
  (:export "MAKE-CD-IMAGE")
  (:documentation "CD image creator."))

(defpackage "CSS"
  (:use "LISP" "EXT")
  (:export "CSS" "PARSE-CSS" "STYLE" "STYLE-PROPERTY")
  (:documentation "Cascading Style Sheet (CSS) support."))
