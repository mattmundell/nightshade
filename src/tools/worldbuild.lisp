...
(setf *genesis-core-name*
      ...
      #-(and mach sparc) "target:bin/kernel.core")
(setf *genesis-c-header-name* "target:bin/internals.h")
(setf *genesis-symbol-table* "target:bin/nightshade.nm")
(setf *genesis-map-name* "target:bin/nightshade.map")
