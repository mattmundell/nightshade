...
;;; FIX else assumes hemlock loaded
...
(with-compilation-unit (:optimize '(optimize (safety 2) (debug 3)))
  (comf "target:hemlock/tty-display")) ; FIX Buggy...
...
(comf "target:hemlock/at-point" :byte-compile t)
...
(comf "target:hemlock/parse" :load t)
(comf "target:hemlock/parse-scribe")
(comf "target:hemlock/info" :byte-compile t)
(comf "target:hemlock/ginfo" :byte-compile t)
...
;(comf "target:hemlock/vc" :byte-compile t)
(comf "target:hemlock/vc")
(comf "target:hemlock/dabbrev" :byte-compile t)
(comf "target:hemlock/calendar")
(comf "target:hemlock/sort" :byte-compile t)
(comf "target:hemlock/csv")
(comf "target:hemlock/www")
(comf "target:hemlock/buildcoms" :byte-compile t)
...
(cat-if-anything-changed
 ...
 "target:hemlock/parse"
 "target:hemlock/parse-scribe"
 "target:hemlock/searchcoms"
 "target:hemlock/filecoms"
 "target:hemlock/info"
 "target:hemlock/ginfo"
 ...
 "target:hemlock/db"
 "target:hemlock/calendar"
 "target:hemlock/sort"
 "target:hemlock/csv"
 "target:hemlock/www"
 "target:hemlock/buildcoms"
