...
;;;
;;; More searching function for Hemlock.  This file contains the stuff to
;;; implement the various kinds of character searches.

(in-package "HEMLOCK-INTERNALS")

(export '(find-character))
